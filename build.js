...
var builders = fs.readdirSync(builders_dir).filter(folder => fs.statSync(folder).isDirectory()).map(folder => {return { "file_Name" : "build.js", "run_at" : join(builders_dir,folder)}});
